              ...
              <table class="table table-striped table-hover table-bordered ">
                ...
                ?>
                  <tr>
                    ...
                    <td><?php echo trim($feed['post']); ?></td>
                    <td>
                      <a onclick="return confirm('Are you sure to Update this Feedback!')" href="updatefeed.php?feedid=<?php echo $feed['feed_id'];?>">Update</a><hr>
                      <a onclick="return confirm('Are you sure to Delete this !')" href="feedback.php?del=<?php echo $feed['feed_id'];?>">Delete</a>
                    </td>
                  </tr>
                <?php $i++;} ?>
              <?php } ?>
